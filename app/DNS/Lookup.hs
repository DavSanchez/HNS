module DNS.Lookup (lookupDomain) where
...
import Network.Socket (AddrInfo (addrAddress, addrFamily), SocketType (Datagram), connect, defaultProtocol, getAddrInfo, socket)
